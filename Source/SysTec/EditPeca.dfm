object fmEditPeca: TfmEditPeca
  ...
  object edQTD_PEC: TCurrencyEdit
    Left = 312
    Top = 188
    Width = 76
    Height = 21
  ...
  object chkAtiva: TCheckBox
    ...
    Width = 145
    Height = 17
    Caption = 'Ficha T'#233'cnica Ativa'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object edQTD_GER: TCurrencyEdit
    Left = 312
    Top = 212
    Width = 76
    Height = 21
