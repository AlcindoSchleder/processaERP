  ...
  object pgItems: TPageControl
    ...
    object tsGrid: TTabSheet
      ...
      object vtItems: TVirtualStringTree
        ...
        Colors.SelectionRectangleBorderColor = clSkyBlue
        Ctl3D = True
        EditDelay = 0
        ...
        WantTabs = True
        OnDblClick = vtItemsDblClick
        OnFocusChanged = vtItemsFocusChanged
        OnGetText = vtItemsGetText
        OnPaintText = vtItemsPaintText
        Columns = <
          item
            ImageIndex = 19
            Position = 0
    ...
    object tsItems: TTabSheet
      ...
      object lNum_Extr: TStaticText
        ...
        AutoSize = False
        BorderStyle = sbsSingle
        Caption = 'N'#250'm. do Cliente: '
        FocusControl = eNum_Extr
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'MS Sans Serif'
  ...
  object cbItems: TCoolBar
    ...
    object tbTools: TToolBar
      ...
      object tbInsert: TToolButton
        Left = 0
        Top = 0
        Hint = 'Novo '#205'tem - <Ins> | Insere novo '#237'tem no pedido'
        Caption = 'Novo'
        ImageIndex = 43
      ...
      object tbCancel: TToolButton
        Left = 56
        Top = 0
        Hint = 'Cancelar | Cancela as altera'#231#245'es do '#237'tem'
        Caption = 'Cancelar'
        Enabled = False
        ImageIndex = 28
      ...
      object tbDelete: TToolButton
        Left = 112
        Top = 0
        Hint = 'Excluir | Exclui o '#237'tem do pedido'
        Caption = 'Excluir'
        Enabled = False
        ImageIndex = 33
      ...
      object tbSave: TToolButton
        Left = 176
        Top = 0
        Hint = 'Confirmar - F12 | Confirma as altera'#231#245'es do '#237'tem'
        Caption = 'Confirmar'
        Enabled = False
        ImageIndex = 83
        OnClick = tbSaveClick
