inherited CdFinanceAcc: TCdFinanceAcc
  Left = 187
  Top = 169
  Width = 800
  Height = 550
  Caption = 'CdFinanceAcc'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object pData: TPanel
    ...
    object lTitle: TLabel
      ...
      Anchors = [akLeft, akTop, akRight]
      AutoSize = False
      Caption = 'Cadastro das Contas do Financeiro'
    ...
    object lFk_Plano_Contas: TStaticText
      Left = 8
      Top = 414
      Width = 123
      Height = 20
    ...
    object eFk_Plano_Contas: TComboBox
      Left = 136
      Top = 413
      Width = 273
      Height = 22
      ...
      ItemHeight = 16
      TabOrder = 12
      OnDrawItem = eFk_Plano_ContasDrawItem
      OnSelect = eFk_Plano_ContasSelect
    end
  end
