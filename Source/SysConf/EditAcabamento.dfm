object fmEditAcabamento: TfmEditAcabamento
  Left = 317
  Top = 248
  ...
  object chkOpcional: TCheckBox
    Left = 288
    Top = 40
    Width = 209
    Height = 17
    Caption = 'Acabamento Opcional'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object edQuantidadePadrao: TCurrencyEdit
    Left = 168
    Top = 40
    Width = 105
    Height = 21
  ...
  object edQuantidadePersonalizada: TCurrencyEdit
    Left = 168
    Top = 64
    Width = 105
    Height = 21
